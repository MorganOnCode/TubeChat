...
## Origin
Rebuild of HoskSaid (Charles Hoskinson transcript site). Generalising to support any YouTube channel with curated topic collections. First collection: UFO/NHI channels.

## Stack
Next.js 16 + Supabase (→ self-hosted Postgres) + Claude Sonnet 4.6 + Whisper + Tailwind + Hetzner VPS

## Key Decisions
- Evolve HoskSaid codebase, don't rewrite
...
- Original HoskSaid repo/deployment untouched
